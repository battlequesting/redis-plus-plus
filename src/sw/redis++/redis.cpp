...
Redis::Redis(const GuardedConnectionSPtr &connection)
...
void Redis::auth(const StringView &password) {
  auto reply =
      command<void (*)(Connection &, const StringView &)>(cmd::auth, password);
...
void Redis::auth(const StringView &user, const StringView &password) {
  auto reply =
      command<void (*)(Connection &, const StringView &, const StringView &)>(
...
std::string Redis::ping(const StringView &msg) {
  auto reply =
      command<void (*)(Connection &, const StringView &)>(cmd::ping, msg);
...
std::string Redis::info(const StringView &section) {
  auto reply =
      command<void (*)(Connection &, const StringView &)>(cmd::info, section);
...
void Redis::restore(const StringView &key, const StringView &val, long long ttl,
                    bool replace) {
...
long long Redis::bitcount(const StringView &key, long long start,
                          long long end) {
...
long long Redis::bitop(BitOp op, const StringView &destination,
...
long long Redis::bitpos(const StringView &key, long long bit, long long start,
                        long long end) {
...
std::string Redis::getrange(const StringView &key, long long start,
                            long long end) {
...
void Redis::psetex(const StringView &key, long long ttl,
...
bool Redis::set(const StringView &key, const StringView &val,
...
bool Redis::set(const StringView &key, const StringView &val, bool keepttl,
                UpdateType type) {
...
long long Redis::setrange(const StringView &key, long long offset,
                          const StringView &val) {
...
OptionalStringPair Redis::blpop(const StringView &key,
...
OptionalStringPair Redis::brpop(const StringView &key,
                                const std::chrono::seconds &timeout) {
...
long long Redis::linsert(const StringView &key, InsertPosition position,
                         const StringView &pivot, const StringView &val) {
...
long long Redis::lrem(const StringView &key, long long count,
                      const StringView &val) {
...
void Redis::lset(const StringView &key, long long index,
                 const StringView &val) {
...
OptionalString Redis::rpoplpush(const StringView &source,
                                const StringView &destination) {
...
long long Redis::hincrby(const StringView &key, const StringView &field,
                         long long increment) {
...
double Redis::hincrbyfloat(const StringView &key, const StringView &field,
                           double increment) {
...
long long Redis::hset(const StringView &key, const StringView &field,
                      const StringView &val) {
...
long long Redis::hset(const StringView &key,
                      const std::pair<StringView, StringView> &item) {
  return hset(key, item.first, item.second);
}

bool Redis::hsetnx(const StringView &key, const StringView &field,
                   const StringView &val) {
...
bool Redis::hsetnx(const StringView &key,
                   const std::pair<StringView, StringView> &item) {
...
bool Redis::smove(const StringView &source, const StringView &destination,
...
long long Redis::sunionstore(const StringView &destination,
                             const StringView &key) {
...
long long Redis::zadd(const StringView &key, const StringView &member,
...
double Redis::zincrby(const StringView &key, double increment,
                      const StringView &member) {
...
long long Redis::zremrangebyrank(const StringView &key, long long start,
                                 long long stop) {
...
OptionalLongLong Redis::zrevrank(const StringView &key,
                                 const StringView &member) {
...
OptionalDouble Redis::geodist(const StringView &key, const StringView &member1,
...
Optional<std::pair<double, double>> Redis::geopos(const StringView &key,
                                                  const StringView &member) {
...
long long Redis::spublish(const StringView &channel,
...
long long Redis::xack(const StringView &key, const StringView &group,
                      const StringView &id) {
...
void Redis::xgroup_create(const StringView &key, const StringView &group,
...
void Redis::xgroup_setid(const StringView &key, const StringView &group,
                         const StringView &id) {
...
long long Redis::xgroup_destroy(const StringView &key,
